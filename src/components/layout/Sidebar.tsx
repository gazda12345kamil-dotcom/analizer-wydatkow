...
import { Home, PlusCircle, PieChart, Wallet, Sparkles, Menu } from "lucide-react";
  ...
  const SidebarContent = () => (
    <>
      ...
      <div className="flex-1 overflow-y-auto px-4 py-2 space-y-2 flex flex-col">
        ...
        {/* Tu w przyszłości dojdą Skarbonki i Subskrypcje */}
        <div className="pt-4 mt-2">
          <p className="px-4 text-xs font-bold text-slate-400 uppercase tracking-widest mb-2">Funkcje Premium</p>
          <div className="px-4 py-3 rounded-xl bg-slate-50 border border-slate-100/50 text-slate-400 text-xs font-medium text-center border-dashed">
            Wkrótce: Skarbonki i Limity
          </div>
        </div>
