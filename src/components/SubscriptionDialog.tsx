                      ...
                      <FormControl>
                        <SelectTrigger>
                          <span className="truncate">
                            {filteredCategories?.find(c => c.id === field.value)?.name || 'Wybierz...'}
                          </span>
                        </SelectTrigger>
                      </FormControl>
                      <SelectContent>
                  ...
                  <FormItem>
                    ...
                    <Select onValueChange={field.onChange} value={field.value}>
                      <FormControl>
                        <SelectTrigger>
                          <span className="truncate">
                            {wallets?.find(w => w.id === field.value)?.name || 'Wybierz...'}
                          </span>
                        </SelectTrigger>
                      </FormControl>
                      <SelectContent>
                    ...
                    <FormItem>
                      ...
                      <Select onValueChange={field.onChange} value={field.value}>
                        <FormControl>
                          <SelectTrigger>
                            <span className="truncate">
                              {field.value === 'weekly' ? 'Co Tydzień' : field.value === 'monthly' ? 'Co Miesiąc' : 'Co Rok'}
                            </span>
                          </SelectTrigger>
                        </FormControl>
                        <SelectContent>
