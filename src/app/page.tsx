  ...
  return (
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-6 duration-500 max-w-6xl mx-auto">
      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="flex overflow-x-auto gap-4 pb-4 -mx-4 px-4 sm:mx-0 sm:px-0 snap-x w-full" style={{ WebkitOverflowScrolling: 'touch', scrollbarWidth: 'none', msOverflowStyle: 'none' }}>
